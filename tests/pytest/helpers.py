...
TESTNET_DID = "did:canow:testnet:DAzMQo4MDMxCjgwM"
TESTNET_FRAGMENT = TESTNET_DID + "#key1"
FAKE_TESTNET_DID = "did:canow:testnet:zF7rhDBfUt9d1gJPjx7s1JXfUY7oVWkY"
...
MAINNET_DID = "did:canow:mainnet:zF7rhDBfUt9d1gJPjx7s1JXfUY7oVWkY"
MAINNET_FRAGMENT = MAINNET_DID + "#key1"
FAKE_MAINNET_DID = "did:canow:mainnet:zFWM1mKVGGU2gHYuLAQcTJfZBebqBpGf"
